      ...
      <div className="mx-auto max-w-page">
        ...
        <ul className="grid gap-4 !lt-xs:grid-cols-1 " style={{ gridTemplateColumns: "3fr 2fr" }}>
          <WorkItem
            ...
            linkToProject="https://washly.kz/"
          />
          <WorkItem
            {...WORKS_DATA.stockify}
            gridRow="xs:g-row-3/5"
            gridColumn="xs:g-col-1/2"
            gradient=" from-[#4C85FF] via-[#4C85FF]/30 "
            borderGradeintFrom="from-[#4C85FF]/90"
            linkToProject="https://stockify.rocks/"
          />
          <WorkItem
            {...WORKS_DATA.apecpetrotechnic}
          ...
          /> */}
          <li className=" rd-3  sahdow-xl  bg-clip-padding xs:g-row-6/9 xs:g-col-2/3 grid">
            <CardContainer
              gradient={""}
            ...
            >
              ...
              >
                <div className="flex flex-col h-full justify-center items-center">
                  <p className="fs-xl c-base11">Very soon...</p>
                </div>
              </div>
            </CardContainer>
          </li>
                ...
                >
                  <div className="flex flex-col h-full">
                    <div className="px-5 pt-5 xs:px-6  xs:pt-5 ">
                      <p className="fs-xl c-base11">Let&apos;s make another successful story, together!</p>
                    </div>
