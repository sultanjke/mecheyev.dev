...
function generateGlowGradient(color: string) {
  return `radial-gradient(circle, ${color} 10%, transparent 20%),
  radial-gradient(circle at 40% 40%, ${color} 5%, transparent 15%),
  radial-gradient(circle at 60% 60%, ${color} 10%, transparent 20%),
  radial-gradient(circle at 40% 60%, ${color} 10%, transparent 20%),
...
function Li(props) {
  const gradient = props.spotlightColor ? generateGlowGradient(props.spotlightColor) : undefined;
  return (
    <li
    ...
    >
      ...
      <div className="flex justify-center items-center p-4  xxs:!p-3 xs:p-4 sm:p-4 h-full relative z-10 rounded-[inherit]">
