    ...
    <div className="flex  md:justify-center">
      <div className="grid md:flex flex-row gap-4 md:gap-6 items-center w-fit">
        <Image
          ...
          width={60}
          height={60}
          className={`object-cover w-12 h-12 rd-2xl bg-gradient-to-br from-blue2 to-green2 shadow-2xl z-10`}
          alt=""
          priority
        ></Image>
        <p className="font-display fs-xl sm:fs-2xl tracking-wider line-height-0.8">Hello. I&apos;m Sultan.</p>
      </div>
    </div>
  );
}
